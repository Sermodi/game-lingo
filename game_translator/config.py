...
class Settings:
    ...
    GOOGLE_TRANSLATE_BASE_URL: str = config("GOOGLE_TRANSLATE_BASE_URL", default="https://translation.googleapis.com/language/translate/v2")
    GOOGLE_TRANSLATE_REQUESTS_PER_SECOND: int = config("GOOGLE_TRANSLATE_REQUESTS_PER_SECOND", default=10, cast=int)
    ...
    DEEPL_REQUESTS_PER_SECOND: int = config("DEEPL_REQUESTS_PER_SECOND", default=5, cast=int)
    ...
    FALLBACK_TRANSLATION_PROVIDER: str = config("FALLBACK_TRANSLATION_PROVIDER", default="google")
    ...
    GOOGLE_CHARACTER_LIMIT: int = config("GOOGLE_CHARACTER_LIMIT", default=10000, cast=int)
    
    # Timeouts
    API_TIMEOUT_SECONDS: int = config("API_TIMEOUT_SECONDS", default=30, cast=int)
    TRANSLATION_TIMEOUT_SECONDS: int = config("TRANSLATION_TIMEOUT_SECONDS", default=60, cast=int)
    
    # Retry Configuration
    MAX_RETRIES: int = config("MAX_RETRIES", default=3, cast=int)
    RETRY_BACKOFF_FACTOR: float = config("RETRY_BACKOFF_FACTOR", default=1.5, cast=float)
