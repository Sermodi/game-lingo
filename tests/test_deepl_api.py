...
class TestDeepLAPIConnector:
    ...
    def test_get_supported_languages_success(self, connector):
        ...
        connector._make_request.assert_called_once_with("languages", data={"type": "target"})
    ...
    def test_translate_game_description_success(self, connector):
        ...
        connector.translate_text = Mock(return_value=TranslationResult(
...
class TestConvenienceFunctions:
    ...
    def test_translate_game_description_function(self, mock_connector_class):
        ...
        mock_connector.translate_game_description.assert_called_once_with("Game description", "ES")
